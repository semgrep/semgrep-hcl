...
(**
    Functions for parsing hcl programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a hcl program from a string into a typed OCaml CST.
...
val string :
  ...
  (CST.config_file, CST.extra) Tree_sitter_run.Parsing_result.t

(** Parse a hcl program from a file into a typed OCaml CST.
